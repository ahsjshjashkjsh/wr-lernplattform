...
export default async function WrPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* QSP-Banner */}
      {new Date() < new Date('2026-04-17T00:00:00') ? (
        <div
        ...
        >
          ...
          <div className="text-xs leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            <span className="font-semibold text-amber-400">Testphase bis 17. April 2026 (QSP) — alles kostenlos.</span>
            {' '}Ab dann sind AP-Inhalte nur mit Premium zugänglich (CHF 5 / 30 Tage).{' '}
            <a href="/premium" className="text-amber-400 underline underline-offset-2 hover:text-amber-300 transition-colors">
              Mehr erfahren →
            </a>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-xs leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            ...
            {' '}Schalte alle Abschlussprüfungs-Kapitel für CHF 5 / 30 Tage frei.{' '}
