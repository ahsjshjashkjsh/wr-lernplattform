...
function TopicCard({ topic }: { topic: TopicWithCount }) {
  ...
  return (
    <Link
      ...
      className="glass glass-hover group rounded-2xl overflow-hidden flex flex-col"
    >
      {/* Top gradient bar */}
      ...
      <div className="p-5 flex flex-col gap-4 flex-1">
        ...
        <div className="flex items-start justify-between">
          ...
          <span className={`text-[11px] font-medium px-2.5 py-1 rounded-full ${examClass}`}>
            {examLabel}
          </span>
        </div>
        ...
        <div className="flex-1">
          <h3 className="font-semibold text-slate-200 group-hover:text-white transition-colors leading-snug">
            {topic.title}
          </h3>
        ...
        <div className="flex items-center justify-between pt-3 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <div className="flex items-center gap-1.5">
            <span className="text-[11px] text-slate-500 bg-white/[0.05] px-2 py-0.5 rounded-full border border-white/[0.06]">
              {catLabel}
            </span>
